...
r_init = 5
f_rng = 30
randoo = [103, 21, 600, 234, 1234, 66, 1000, 1589, 4142] #[42, 
rand_flag = [0]
qq = [5]
sigg = [1]
dd = [4]
...
#path1 = "/workspace/host/Experiments/Synthetic/Synthetic_other/BRANIN/ALEBO/"
path1 = "GPR_files/bone/samples/Experiments/Synthetic/Synthetic_other/BRANIN/ALEBO/"
...
def sc_evaluation_function(parameterization):
    ...
    return {"objective": (branin(x[0:2]), 0.0)}
                ...
                for rando in randoo:
                    ...
                    for no_rand in rand_flag:
                        if(no_rand==0):
                            ...
                            mu_rng[np.where(mu_rng[:,0]==0.0),1] = 3.142
                            mu_rng[np.where(mu_rng[:,0]==1.0),1] = 2.275
                        ...
                        parameters = [
                            ...
                            {"name": "x1", "type": "range", "bounds": [0, 15.0], "value_type": "float"},
                        ]
                        parameters.extend([
