...
r_init = 5
f_rng = 5
randoo = [2]#, 103, 21, 600, 234, 1234, 66, 1000, 1589, 4142]
rand_flag = [0]
qq = [5]
sigg = [1]
dd = [4, 10, 20] #[4, 
...
path1 = "GPR_files/bone/samples/Experiments/Synthetic/Synthetic_perception/ALEBO/hyper2/"
            ...
            for D in DD:
                for rando in randoo:
                    ...
                    for no_rand in rand_flag:
                        ...
                        if(D==500 and d==4 and q==5 and sig==1 or (D==4000 and d==4 and q==5 and sig==1)or (D==500 and d==10 and q==5 and sig==1)or (D==4000 and d==10 and q==5 and sig==1)):
                            kkk = 0
                        else:   
