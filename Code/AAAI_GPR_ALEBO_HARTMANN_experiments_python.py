...
#path1 = "/workspace/host/Experiments/Synthetic/Synthetic_other/HARTMANN/ALEBO/"
path1 = "GPR_files/bone/samples/Experiments/Synthetic/Synthetic_other/HARTMANN/ALEBO/"
                ...
                for rando in randoo:
                    ...
                    for no_rand in rand_flag:
                        if(no_rand==0):
                            ...
                            mu_rng[np.where(mu_rng[:,0]==0.0),1] = 0.20169
                            mu_rng[np.where(mu_rng[:,0]==1.0),1] = 0.150011
                            mu_rng[np.where(mu_rng[:,0]==2.0),1] = 0.476874
                            mu_rng[np.where(mu_rng[:,0]==3.0),1] = 0.275332
                            mu_rng[np.where(mu_rng[:,0]==4.0),1] = 0.311652
                            mu_rng[np.where(mu_rng[:,0]==5.0),1] = 0.6573
                        ...
                        os.mkdir(path)
                        parameters = [
                            {"name": "x0", "type": "range", "bounds": [0, 1.0], "value_type": "float"},
                            {"name": "x1", "type": "range", "bounds": [0, 1.0], "value_type": "float"},
                        ]
                        parameters.extend([
